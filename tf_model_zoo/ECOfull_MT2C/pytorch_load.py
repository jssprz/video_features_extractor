...
class ECOfull_MT2C(nn.Module):
    def __init__(self, model_path='tf_model_zoo/ECOfull_MT2C/ECOfull_MT2C.yaml', num_classes=101,
                       num_segments=4, pretrained_parts='both'):

        super(ECOfull_MT2C, self).__init__()
    ...
    def forward(self, input,*feature_name):
        ...
        # exit()
        #print("op0 {}".format(op[0]))
        #print("op1 {}".format(op[1]))
        #print("op2 {}".format(op[2]))
        #print("op-1 {}".format(op[-1]))
        #print("op3 {}".format(op[3]))
        #print("op-2 {}".format(op[-2]))
        #print("op-3 {}".format(op[-3]))
